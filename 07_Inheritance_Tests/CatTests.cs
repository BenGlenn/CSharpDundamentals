...
namespace _07_Inheritance_Tests
{
    ...
    public class CatTests
    {
        ...
        public void ConstructorTests()
        {
            ...
            garfield.TeethSize = "kinda large"; // works cuz of casting on content

            //content.TeethSize = "Kinda Large" will not work cuz we are pulling from Cat class 

            Liger billyJoel = new Liger();
            billyJoel.Move();
            billyJoel.MakeSound();

            billyJoel.TeethSize = "Reeally big.";
        }
